<template>
  <q-layout view="hHh LpR fFf">
    <q-header
      class="absolute-top bg-transparent text-white container"
      :class="{ 'q-px-md': $q.screen.lt.sm }"
    >
      <q-toolbar
        class="row no-wrap items-center flex items-center justify-between"
        style="gap: 36px; padding: 13px 0px"
      >
        <img
          alt="Hyperhire Logo"
          src="data:image/png;base64,"
          style="width: 114px; height: 21px"
        />

        <div class="flex" style="gap: 60px" v-if="$q.screen.gt.xs">
          <div
            class="cursor-pointer non-selectable flex items-center"
            style="gap: 8px"
          >
            채용
            <svg
            ...
            <q-menu>
              <q-list style="min-width: 100px">
                <q-item clickable v-close-popup>
                  <q-item-section class="text-menu-bold">채용</q-item-section>
                </q-item>
                <q-item clickable v-close-popup>
                  <q-item-section class="text-menu"
                    >해외 개발자 원격 채용</q-item-section
                  >
                </q-item>
                <q-item clickable v-close-popup>
                  <q-item-section class="text-menu"
        ...
        >
          <q-scroll-area class="fit">
            <div class="q-pa-lg text-color-1">
              <q-list style="min-width: 100px; margin-bottom: 32px">
                <q-item clickable v-close-popup>
                  <q-item-section class="text-menu-bold">채용</q-item-section>
                </q-item>
                <q-item clickable v-close-popup>
                  <q-item-section class="text-menu q-pl-md"
                    >해외 개발자 원격 채용</q-item-section
                  >
                </q-item>
                <q-item clickable v-close-popup>
                ...
                <q-separator />
                <q-item clickable v-close-popup>
                  <q-item-section class="text-menu-bold">
                    해외 개발자 활용 서비스
                  </q-item-section>
                </q-item>
              </q-list>
              <q-btn
                ...
                label="문의하기"
                style="
                  background-color: rgb(38, 194, 185);
        ...
        <q-btn
          ...
          v-if="$q.screen.gt.xs"
        />
        <q-btn flat round dense v-else
          ><q-icon name="menu" @click="drawerRight = !drawerRight" />
        </q-btn>
      </q-toolbar>
    </q-header>
    <q-page-container style="padding-top: 0px">
      <q-page
        ...
        :style="{
          padding: $q.screen.lt.sm ? '60px 0px' : '122px 0px',
        }"
      >
        <div class="container" :class="{ 'q-pa-md': $q.screen.lt.sm }">
          <div
            :class="{ 'grid-cols-2 grid': $q.screen.gt.xs }"
            style="gap: 36px"
          >
            <div class="column" style="gap: 60px">
              <div class="column" style="gap: 24px">
                <div class="column" style="gap: 16px">
                  <transition
                    appear
                    enter-active-class="animated fadeIn slower delay-3s"
                  >
                    <div style="position: relative">
                      <div
                        :class="{ 'text-color-8': $q.screen.gt.xs }"
                        style="
                          font-size: 18px;
                          width: fit-content;
                          padding: 6px 12px;
                      ...
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        style="position: absolute; bottom: -9px; left: 9px"
                        :style="{
                          color: $q.screen.lt.sm
                            ? 'rgb(139, 196, 255)'
                            : 'rgb(255, 255, 255)',
                        }"
                      >
                  ...
                  >
                    <div
                      :style="{
                        fontSize: $q.screen.gt.xs ? '48px' : '36px',
                      }"
                    >
                      최고의 실력을 가진<br />
                      외국인 인재를 찾고 계신가요?
                  ...
                  <transition appear enter-active-class="animated fadeInUp slow"
                    ><div
                      :style="{
                        fontSize: $q.screen.gt.xs ? '24px' : '18px',
                      }"
                    >
                      법률 및 인사관리 부담없이<br />
                      1주일 이내에 원격으로 채용해보세요.
                ...
                <transition
                  ...
                  v-if="$q.screen.gt.xs"
                >
                  <div style="font-size: 18px">개발자가 필요하신가요?</div>
                </transition>
              </div>
              <transition
                appear
                ...
                v-if="$q.screen.gt.xs"
              >
                <div class="grid grid-cols-3" style="gap: 48px">
                  <div
                    ...
                    "
                  >
                    <div style="font-size: 18px">평균 월 120만원</div>
            ...
            <div
              :style="{
                paddingTop: $q.screen.gt.xs ? '0px' : '36px',
              }"
            >
              <div
                style="position: relative; width: fit-content; margin: 0px auto"
              >
                <div
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  style="position: absolute; bottom: -9px; left: 50%"
                >
                  <path
                    d="M6.43301 10.25C6.24056 10.5833 5.75944 10.5833 5.56699 10.25L0.370835 1.25C0.178386 0.916665 0.418948 0.499999 0.803848 0.499999L11.1962 0.5C11.5811 0.5 11.8216 0.916667 11.6292 1.25L6.43301 10.25Z"
                    fill="currentColor"
              ...
              <div
                class="column"
                style="gap: 8px; margin-top: 24px; font-size: 16px"
                v-if="$q.screen.lt.sm"
              >
                <div class="flex" style="gap: 8px">
                  <div class="flex" style="gap: 12px">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <rect width="20" height="20" rx="6" fill="#E8ECFF"></rect>
                      <path
        ...
        <MiniSwiper v-if="$q.screen.gt.xs" />
      </q-page>
    </q-page-container>
    <footer>
...
import BigSwiper from 'src/components/BigSwiper.vue';
import MiniSwiper from 'src/components/MiniSwiper.vue';
